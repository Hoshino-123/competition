...
public class Zuopinpingfen {
    ...
    }	public String getZuopinfenshu() {
        return zuopinfenshu;
    }
    public void setZuopinfenshu(String zuopinfenshu) {
		this.zuopinfenshu = zuopinfenshu;
    }	
