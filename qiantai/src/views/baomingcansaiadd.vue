  ...
  <div id="details">
    ...
    <div class="main">
      <div class="content">
		...
		<el-form-item  label='参赛作品' prop='cansaizuopin'><el-upload class='avatar-uploader' action='/api/files/front/uploadwenjian' :headers='headers' :show-file-list='false' :on-success='handleCansaizuopinSuccess' ><el-button>上传</el-button></el-upload></el-form-item>
...
jingsaididian:'',
	...
	//xia2sui1
	  ...
	  getDetails(id){
			this.$axios
                .get("/api/front/getjingsaixinxidetail/"+id,)
                .then(res => {
                  this.jingsaixinxi = res.data.data;
                  this.editForm.jingsaibianhao = this.jingsaixinxi.jingsaibianhao;
                    ...
                    this.editForm.zhidaolaoshi= this.jingsaixinxi.zhidaolaoshi;
        ...
        this.$refs[editData].validate(valid => {
          if (valid) {
            if(this.editForm.id){
              ...
              this.$axios
                      .post("/api/front/postbaomingcansai/",this.editForm)
                      .then(res => {
                        if (res.data.code == '0') {
						//kuabiaogaizhi1
                          this.$message({
						...
						else if (res.data.code == '5000') { this.$message({type: 'error',message: res.data.msg})}
						else {
                          this.$message({
                            type: 'info',
                            message: res.msg
