	...
	<div class="layout-navbars-breadcrumb-user" :style="{ flex: layoutUserFlexNum }">
		<el-dropdown :show-timeout="70" :hide-timeout="50" @command="onDropdownCommand">
			<span class="layout-navbars-breadcrumb-user-link">
				<img v-if="getUserInfos.avater" :src="getUserInfos.avater" class="layout-navbars-breadcrumb-user-link-photo mr5" />
				<img src="../../../../static/images/guanli.jpg" class="layout-navbars-breadcrumb-user-link-photo mr5" />
